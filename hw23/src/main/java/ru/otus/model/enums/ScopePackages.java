...
public enum ScopePackages {
    ...
    main("main", ScopePackagesGroups.MAIN, "Основной"),
    ...
    CHENG_ORDER_STATUSES_FOR_BOOKKEEPER("chengOrderStatusesForBookkeeper", ScopePackagesGroups.ORDER_STATUSES, "Смена статуса заказа для бухгалтерии");
    ...
    private final static Map<String, ScopePackages> DESCRIPTIONS = Arrays.stream(ScopePackages.values())
            .collect(Collectors.toMap(
                    ScopePackages::getPackageDescription,
                    scopePackages -> scopePackages));
    ...
    public static ScopePackages getByDescription(String name) {
