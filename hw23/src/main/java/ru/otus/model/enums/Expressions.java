...
public enum Expressions {
    ...
    ERROR_MESSAGE("Error::sendMessage", "Отправить сообщение об ошибке"),
    ...
    private final static Map<String, Expressions> DESCRIPTIONS = Arrays.stream(Expressions.values())
            .collect(Collectors.toMap(
                    Expressions::getExpressionDescription,
                    expressions -> expressions));
    ...
    public static Expressions getByDescription(String name) {
